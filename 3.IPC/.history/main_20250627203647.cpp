...
void initialize() {
    ...
    struct sched_param param_staff,param_;
    pthread_attr_init(&attr);
    pthread_attr_setschedpolicy(&attr, SCHED_RR);  // Real-time Round Robin
    param.sched_priority = 20;  // Higher than writer
...
//     cout<<"Intelligence Staff "<<*staff<<" began reviewing logbook at time "<<to_string(get_time())<<". Operations completed = "<<operations_completed<<endl;
